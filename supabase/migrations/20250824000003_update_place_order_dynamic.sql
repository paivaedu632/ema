-- Update place_order function to support dynamic pricing
-- Migration: 20250824000003_update_place_order_dynamic.sql

-- Enhanced place_order function with dynamic pricing support
...
BEGIN
    ...
    INSERT INTO fund_reservations (user_id, currency, reserved_amount, status)
